...
const getBadgeColor = (type?: string) => {
  ...
  // const badgeText = getCollectionTypeLabel(collection_type);
    ...
    <div className="shadow-md border-gray-200 overflow-hidden transition-shadow hover:shadow-md">
      <Link to={`/product/${id}`} className="group block">
        <div className="relative h-[200px] sm:h-[360px] md:h-[430px] bg-gray-100">
          ...
          {/* 🔧 Badge faqat collection_type mavjud bo‘lsa chiqadi */}
          {collection_type && getCollectionTypeLabel(collection_type) && (
